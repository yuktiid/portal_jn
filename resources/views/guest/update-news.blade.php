...
<section class="section dashboard">
    <div class="row">
        <form class="row needs-validation" action="{{route('guest.Pupdate', ['id'=>$data->id_post])}}" enctype="multipart/form-data" method="post" novalidate>
            @method('put')
            @csrf
            <!-- Left side columns -->
            <div class="col-lg-8">
                <div class="card ">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="judul" class="form-control" id="validationCustom01" value="{{$data->judul}}" placeholder="Masukkan Judul..." required>
                ...
                <div class="card">
                    <div class="card-body">
                            ...
                            <div class="row align-items-center">
                                <div class="">
                                    <div class="input-group mb-3 ">
                                        <input type="file" id="input-type-file" class="form-control" name="foto" style="border-radius: 5px 0 0 5px;" aria-label="file example" onchange="readUrl(this)">
                                ...
                                <div class="mb-3">
                                    <img src="{{$link}}{{$data->foto}}" class="w-100 shadow" alt="" for="input-type-file" id="gam">
                                </div>
                                <div class="form-floating">
                                    <textarea class="form-control" name="keterangan_foto" id="keterangan_foto" style="height: 70px" required>{!! $data->keterangan_foto !!}</textarea>
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="flush-collapseOne" class="accordion-collapse collapse text-capitalize text-dark show" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                                        <div class="accordion-body" id="kategori-body">
                                            ...
                                            @forelse ($data->Kategoris as $kts)
                                            @php
                                            $founds = false;
                                            @endphp
                                            @if ($kts->id_kategori == $kt["id_kategori"])
                                            @php
                                            $founds = true;
                                            @endphp
                                            @break
                                            ...
                                            <div class="form-check" style="font-size: 16px;">
                                                <input class="form-check-input" type="checkbox" name="id_kategori[]" value="{{$kt['id_kategori']}}" id="gridCheck{{$kt['id_kategori']}}" @if ($founds==1 ) checked @endif>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="zona" name="id_wilayah" required>
                                @if ($data->wilayah != null)
                                <option selected value="{{$data->wilayah->id_wilayah}}">{{$data->wilayah->nama_wilayah}}</option>
                                @else
                        ...
                        <div class="mb-3">
                            <label for="skill" class="form-label">Tags</label>
                            <input type="text" name="tags" id="skill" class="form-control" value="
                        ...
                        <div class="col-12">
                            <button class="btn btn-primary" type="submit" id="kirim">Simpan</button>
                        </div>
                    </div>
                </div>
