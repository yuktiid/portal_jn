@php
    ...
    // kategori
        $client = new Client();
        $response = $client->get('https://pro1v1jn.jurnalnusa.com/jurnal/navbar');
...
<head>
    ...
    <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-4918078179726425"crossorigin="anonymous">
    </script>
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col">
                                            <form class="input-group" role="search" action="/search">
                                                <input class="form-control me-2 rounded-pill" name="keyword" type="search" placeholder="mau cari berita apa?" aria-label="Search" value="@yield('search')">
            ...
            <div class="container col-lg-8">
                <div class="d-none d-lg-block">
                    <a class="navbar-brand" href="/">
                        <img loading="lazy" src="{{ asset('crop1.jpeg') }}" alt="Logo" width="auto" height="50"
        ...
        <div class="row d-flex justify-content-center m-0 p-0">
            ...
            <div class="col col-lg-8">
                    ...
                    <div class="container">
                        <div class="row d-flex align-items-center justify-content-center ">
                            ...
                            <div class="col-lg-8 text-end">
                                <a href="{{ $iklanP->link}}" target="_blank"><img loading="lazy" src="https://pro1v1jn.jurnalnusa.com/iklans/img/{{ $iklanP->gambar }}" class="w-75 rounded-1" alt=""></a>
                            </div>
                ...
                <div class="d-block d-md-none text-center my-2">
                    <img loading="lazy" src="https://pro1v1jn.jurnalnusa.com/iklans/img/{{ $iklanP->gambar }}" class="w-100 rounded-1" alt="">
                </div>
                <!-- end header content -->
                @yield('content')
            ...
            <div class="container text-md-start mt-md-3 mt-sm-1">
                ...
                <div class="row mt-3 ms-2">
                    <div class="row col-12 col-lg-8 col-md-8">
                        ...
                        <div class="col-8"><p><b>JurnalNusa</b> – Spectrum positif jurnalism</p>
                        <p class="fw-medium fs-13">Media online proyeksi nasional berbasis positif jurnalism, akuntable dan edukatif hadir dengan perspektif baru media pers</p></div>
                    </div>
            ...
            <div class="container">
                ...
                <div class="row mt-3 text-center">
                    ...
                    <div class="col-lg-4 col-12 text-dark fw-bolder fs-12">
                        Design & Development By <a href="https://wa.me/6281233422006" class="text-decoration-none"><img loading="lazy" src="{{ asset('log22.png') }}" class="ms-1 w-25 rounded-1" alt=""></a>
                    </div>
