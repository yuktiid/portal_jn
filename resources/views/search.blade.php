@extends('lay.layout')
@section('title', 'jurnalnusa - search')
@section('search', $data->keyword)
...
<section class="my-3 d-flex justify-content-center">
    <div class="container">
        ...
        <div class="row d-flex justify-content-center">
            <!-- left -->
            <div class="col-md-12">
                <p>Hasil pencarian <p class="fw-bold">"{{$data->keyword}}"</p></p>
                <!-- news new 1-->
                        ...
                        <div class="post mb-4">
                            <div class="card border-0 bg-light p-0">
                                ...
                                <div class=" wrapper card-header border-0 rounded-top bg-transparent p-0 pb-1">
                                    <img loading="lazy" src="{{ $imgUrl }}/posts/img/{{$item->foto}}" class="rounded-1 w-100" style="height: 200px; object-fit: cover;" alt="{{$item->judul}}">
                                </div>
